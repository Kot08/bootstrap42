       ...
       <div class="row mt-4">
        <div class="col-md-12">
          <h2 class="text-center">Draggable</h2>
            ...
            <div class="col-md-4">
              <img src="img/Desert.jpg" class="img-fluid" alt="" id="kart1">
            </div>
            <div class="col-md-4">
              <img src="img/Hydrangeas.jpg" class="img-fluid" alt="" id="kart2">
            </div>
            <div class="col-md-4">
               <img src="img/Jellyfish.jpg" class="img-fluid" alt="" id="kart3">
            </div>
          </div>
